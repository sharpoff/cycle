...
void RenderDevice::CreateDevice()
{
    ...
    LOG_PRINTF("Selected GPU: %s", deviceProperties.deviceName);

    // Log GPU limits
    if (ENABLE_LOG_DEVICE_LIMITS) {
        LOG_PRINTF("---- deviceProperties.limits ----");
        LOG_PRINTF("\tmaxImageDimension1D: %u", deviceProperties.limits.maxImageDimension1D);
        LOG_PRINTF("\tmaxImageDimension2D: %u", deviceProperties.limits.maxImageDimension2D);
        LOG_PRINTF("\tmaxImageDimension3D: %u", deviceProperties.limits.maxImageDimension3D);
        LOG_PRINTF("\tmaxImageDimensionCube: %u", deviceProperties.limits.maxImageDimensionCube);
        LOG_PRINTF("\tmaxImageArrayLayers: %u", deviceProperties.limits.maxImageArrayLayers);
        LOG_PRINTF("\tmaxTexelBufferElements: %u", deviceProperties.limits.maxTexelBufferElements);
        LOG_PRINTF("\tmaxUniformBufferRange: %u", deviceProperties.limits.maxUniformBufferRange);
        LOG_PRINTF("\tmaxStorageBufferRange: %u", deviceProperties.limits.maxStorageBufferRange);
        LOG_PRINTF("\tmaxPushConstantsSize: %u", deviceProperties.limits.maxPushConstantsSize);
        LOG_PRINTF("\tmaxMemoryAllocationCount: %u", deviceProperties.limits.maxMemoryAllocationCount);
        LOG_PRINTF("\tmaxSamplerAllocationCount: %u", deviceProperties.limits.maxSamplerAllocationCount);
        LOG_PRINTF("\tbufferImageGranularity: %lu", deviceProperties.limits.bufferImageGranularity);
        LOG_PRINTF("\tsparseAddressSpaceSize: %lu", deviceProperties.limits.sparseAddressSpaceSize);
        LOG_PRINTF("\tmaxBoundDescriptorSets: %u", deviceProperties.limits.maxBoundDescriptorSets);
        LOG_PRINTF("\tmaxPerStageDescriptorSamplers: %u", deviceProperties.limits.maxPerStageDescriptorSamplers);
        LOG_PRINTF("\tmaxPerStageDescriptorUniformBuffers: %u", deviceProperties.limits.maxPerStageDescriptorUniformBuffers);
        LOG_PRINTF("\tmaxPerStageDescriptorStorageBuffers: %u", deviceProperties.limits.maxPerStageDescriptorStorageBuffers);
        LOG_PRINTF("\tmaxPerStageDescriptorSampledImages: %u", deviceProperties.limits.maxPerStageDescriptorSampledImages);
        LOG_PRINTF("\tmaxPerStageDescriptorStorageImages: %u", deviceProperties.limits.maxPerStageDescriptorStorageImages);
        LOG_PRINTF("\tmaxPerStageDescriptorInputAttachments: %u", deviceProperties.limits.maxPerStageDescriptorInputAttachments);
        LOG_PRINTF("\tmaxPerStageResources: %u", deviceProperties.limits.maxPerStageResources);
        LOG_PRINTF("\tmaxDescriptorSetSamplers: %u", deviceProperties.limits.maxDescriptorSetSamplers);
        LOG_PRINTF("\tmaxDescriptorSetUniformBuffers: %u", deviceProperties.limits.maxDescriptorSetUniformBuffers);
        LOG_PRINTF("\tmaxDescriptorSetUniformBuffersDynamic: %u", deviceProperties.limits.maxDescriptorSetUniformBuffersDynamic);
        LOG_PRINTF("\tmaxDescriptorSetStorageBuffers: %u", deviceProperties.limits.maxDescriptorSetStorageBuffers);
        LOG_PRINTF("\tmaxDescriptorSetStorageBuffersDynamic: %u", deviceProperties.limits.maxDescriptorSetStorageBuffersDynamic);
        LOG_PRINTF("\tmaxDescriptorSetSampledImages: %u", deviceProperties.limits.maxDescriptorSetSampledImages);
        LOG_PRINTF("\tmaxDescriptorSetStorageImages: %u", deviceProperties.limits.maxDescriptorSetStorageImages);
        LOG_PRINTF("\tmaxDescriptorSetInputAttachments: %u", deviceProperties.limits.maxDescriptorSetInputAttachments);
        LOG_PRINTF("\tmaxVertexInputAttributes: %u", deviceProperties.limits.maxVertexInputAttributes);
        LOG_PRINTF("\tmaxVertexInputBindings: %u", deviceProperties.limits.maxVertexInputBindings);
        LOG_PRINTF("\tmaxVertexInputAttributeOffset: %u", deviceProperties.limits.maxVertexInputAttributeOffset);
        LOG_PRINTF("\tmaxVertexInputBindingStride: %u", deviceProperties.limits.maxVertexInputBindingStride);
        LOG_PRINTF("\tmaxVertexOutputComponents: %u", deviceProperties.limits.maxVertexOutputComponents);
        LOG_PRINTF("\tmaxTessellationGenerationLevel: %u", deviceProperties.limits.maxTessellationGenerationLevel);
        LOG_PRINTF("\tmaxTessellationPatchSize: %u", deviceProperties.limits.maxTessellationPatchSize);
        LOG_PRINTF("\tmaxTessellationControlPerVertexInputComponents: %u", deviceProperties.limits.maxTessellationControlPerVertexInputComponents);
        LOG_PRINTF("\tmaxTessellationControlPerVertexOutputComponents: %u", deviceProperties.limits.maxTessellationControlPerVertexOutputComponents);
        LOG_PRINTF("\tmaxTessellationControlPerPatchOutputComponents: %u", deviceProperties.limits.maxTessellationControlPerPatchOutputComponents);
        LOG_PRINTF("\tmaxTessellationControlTotalOutputComponents: %u", deviceProperties.limits.maxTessellationControlTotalOutputComponents);
        LOG_PRINTF("\tmaxTessellationEvaluationInputComponents: %u", deviceProperties.limits.maxTessellationEvaluationInputComponents);
        LOG_PRINTF("\tmaxTessellationEvaluationOutputComponents: %u", deviceProperties.limits.maxTessellationEvaluationOutputComponents);
        LOG_PRINTF("\tmaxGeometryShaderInvocations: %u", deviceProperties.limits.maxGeometryShaderInvocations);
        LOG_PRINTF("\tmaxGeometryInputComponents: %u", deviceProperties.limits.maxGeometryInputComponents);
        LOG_PRINTF("\tmaxGeometryOutputComponents: %u", deviceProperties.limits.maxGeometryOutputComponents);
        LOG_PRINTF("\tmaxGeometryOutputVertices: %u", deviceProperties.limits.maxGeometryOutputVertices);
        LOG_PRINTF("\tmaxGeometryTotalOutputComponents: %u", deviceProperties.limits.maxGeometryTotalOutputComponents);
        LOG_PRINTF("\tmaxFragmentInputComponents: %u", deviceProperties.limits.maxFragmentInputComponents);
        LOG_PRINTF("\tmaxFragmentOutputAttachments: %u", deviceProperties.limits.maxFragmentOutputAttachments);
        LOG_PRINTF("\tmaxFragmentDualSrcAttachments: %u", deviceProperties.limits.maxFragmentDualSrcAttachments);
        LOG_PRINTF("\tmaxFragmentCombinedOutputResources: %u", deviceProperties.limits.maxFragmentCombinedOutputResources);
        LOG_PRINTF("\tmaxComputeSharedMemorySize: %u", deviceProperties.limits.maxComputeSharedMemorySize);
        LOG_PRINTF("\tmaxComputeWorkGroupCount[0]: %u", deviceProperties.limits.maxComputeWorkGroupCount[0]);
        LOG_PRINTF("\tmaxComputeWorkGroupCount[1]: %u", deviceProperties.limits.maxComputeWorkGroupCount[1]);
        LOG_PRINTF("\tmaxComputeWorkGroupCount[2]: %u", deviceProperties.limits.maxComputeWorkGroupCount[2]);
        LOG_PRINTF("\tmaxComputeWorkGroupInvocations: %u", deviceProperties.limits.maxComputeWorkGroupInvocations);
        LOG_PRINTF("\tmaxComputeWorkGroupSize[0]: %u", deviceProperties.limits.maxComputeWorkGroupSize[0]);
        LOG_PRINTF("\tmaxComputeWorkGroupSize[1]: %u", deviceProperties.limits.maxComputeWorkGroupSize[1]);
        LOG_PRINTF("\tmaxComputeWorkGroupSize[2]: %u", deviceProperties.limits.maxComputeWorkGroupSize[2]);
        LOG_PRINTF("\tsubPixelPrecisionBits: %u", deviceProperties.limits.subPixelPrecisionBits);
        LOG_PRINTF("\tsubTexelPrecisionBits: %u", deviceProperties.limits.subTexelPrecisionBits);
        LOG_PRINTF("\tmipmapPrecisionBits: %u", deviceProperties.limits.mipmapPrecisionBits);
        LOG_PRINTF("\tmaxDrawIndexedIndexValue: %u", deviceProperties.limits.maxDrawIndexedIndexValue);
        LOG_PRINTF("\tmaxDrawIndirectCount: %u", deviceProperties.limits.maxDrawIndirectCount);
        LOG_PRINTF("\tmaxSamplerLodBias: %f", deviceProperties.limits.maxSamplerLodBias);
        LOG_PRINTF("\tmaxSamplerAnisotropy: %f", deviceProperties.limits.maxSamplerAnisotropy);
        LOG_PRINTF("\tmaxViewports: %u", deviceProperties.limits.maxViewports);
        LOG_PRINTF("\tmaxViewportDimensions[0]: %u", deviceProperties.limits.maxViewportDimensions[0]);
        LOG_PRINTF("\tmaxViewportDimensions[1]: %u", deviceProperties.limits.maxViewportDimensions[1]);
        LOG_PRINTF("\tviewportBoundsRange[0]: %f", deviceProperties.limits.viewportBoundsRange[0]);
        LOG_PRINTF("\tviewportBoundsRange[1]: %f", deviceProperties.limits.viewportBoundsRange[1]);
        LOG_PRINTF("\tviewportSubPixelBits: %u", deviceProperties.limits.viewportSubPixelBits);
        LOG_PRINTF("\tminMemoryMapAlignment: %lu", deviceProperties.limits.minMemoryMapAlignment);
        LOG_PRINTF("\tminTexelBufferOffsetAlignment: %lu", deviceProperties.limits.minTexelBufferOffsetAlignment);
        LOG_PRINTF("\tminUniformBufferOffsetAlignment: %lu", deviceProperties.limits.minUniformBufferOffsetAlignment);
        LOG_PRINTF("\tminStorageBufferOffsetAlignment: %lu", deviceProperties.limits.minStorageBufferOffsetAlignment);
        LOG_PRINTF("\tminTexelOffset: %u", deviceProperties.limits.minTexelOffset);
        LOG_PRINTF("\tmaxTexelOffset: %u", deviceProperties.limits.maxTexelOffset);
        LOG_PRINTF("\tminTexelGatherOffset: %u", deviceProperties.limits.minTexelGatherOffset);
        LOG_PRINTF("\tmaxTexelGatherOffset: %u", deviceProperties.limits.maxTexelGatherOffset);
        LOG_PRINTF("\tminInterpolationOffset: %f", deviceProperties.limits.minInterpolationOffset);
        LOG_PRINTF("\tmaxInterpolationOffset: %f", deviceProperties.limits.maxInterpolationOffset);
        LOG_PRINTF("\tsubPixelInterpolationOffsetBits: %u", deviceProperties.limits.subPixelInterpolationOffsetBits);
        LOG_PRINTF("\tmaxFramebufferWidth: %u", deviceProperties.limits.maxFramebufferWidth);
        LOG_PRINTF("\tmaxFramebufferHeight: %u", deviceProperties.limits.maxFramebufferHeight);
        LOG_PRINTF("\tmaxFramebufferLayers: %u", deviceProperties.limits.maxFramebufferLayers);
        LOG_PRINTF("\tframebufferColorSampleCounts: %u", deviceProperties.limits.framebufferColorSampleCounts);
        LOG_PRINTF("\tframebufferDepthSampleCounts: %u", deviceProperties.limits.framebufferDepthSampleCounts);
        LOG_PRINTF("\tframebufferStencilSampleCounts: %u", deviceProperties.limits.framebufferStencilSampleCounts);
        LOG_PRINTF("\tframebufferNoAttachmentsSampleCounts: %u", deviceProperties.limits.framebufferNoAttachmentsSampleCounts);
        LOG_PRINTF("\tmaxColorAttachments: %u", deviceProperties.limits.maxColorAttachments);
        LOG_PRINTF("\tsampledImageColorSampleCounts: %u", deviceProperties.limits.sampledImageColorSampleCounts);
        LOG_PRINTF("\tsampledImageIntegerSampleCounts: %u", deviceProperties.limits.sampledImageIntegerSampleCounts);
        LOG_PRINTF("\tsampledImageDepthSampleCounts: %u", deviceProperties.limits.sampledImageDepthSampleCounts);
        LOG_PRINTF("\tsampledImageStencilSampleCounts: %u", deviceProperties.limits.sampledImageStencilSampleCounts);
        LOG_PRINTF("\tstorageImageSampleCounts: %u", deviceProperties.limits.storageImageSampleCounts);
        LOG_PRINTF("\tmaxSampleMaskWords: %u", deviceProperties.limits.maxSampleMaskWords);
        LOG_PRINTF("\ttimestampComputeAndGraphics: %s", deviceProperties.limits.timestampComputeAndGraphics ? "true" : "false");
        LOG_PRINTF("\ttimestampPeriod: %f", deviceProperties.limits.timestampPeriod);
        LOG_PRINTF("\tmaxClipDistances: %u", deviceProperties.limits.maxClipDistances);
        LOG_PRINTF("\tmaxCullDistances: %u", deviceProperties.limits.maxCullDistances);
        LOG_PRINTF("\tmaxCombinedClipAndCullDistances: %u", deviceProperties.limits.maxCombinedClipAndCullDistances);
        LOG_PRINTF("\tdiscreteQueuePriorities: %u", deviceProperties.limits.discreteQueuePriorities);
        LOG_PRINTF("\tpointSizeRange[0]: %f", deviceProperties.limits.pointSizeRange[0]);
        LOG_PRINTF("\tpointSizeRange[1]: %f", deviceProperties.limits.pointSizeRange[1]);
        LOG_PRINTF("\tlineWidthRange[0]: %f", deviceProperties.limits.lineWidthRange[0]);
        LOG_PRINTF("\tlineWidthRange[1]: %f", deviceProperties.limits.lineWidthRange[1]);
        LOG_PRINTF("\tpointSizeGranularity: %f", deviceProperties.limits.pointSizeGranularity);
        LOG_PRINTF("\tlineWidthGranularity: %f", deviceProperties.limits.lineWidthGranularity);
        LOG_PRINTF("\tstrictLines: %s", deviceProperties.limits.strictLines ? "true" : "false");
        LOG_PRINTF("\tstandardSampleLocations: %s", deviceProperties.limits.standardSampleLocations ? "true" : "false");
        LOG_PRINTF("\toptimalBufferCopyOffsetAlignment: %lu", deviceProperties.limits.optimalBufferCopyOffsetAlignment);
        LOG_PRINTF("\toptimalBufferCopyRowPitchAlignment: %lu", deviceProperties.limits.optimalBufferCopyRowPitchAlignment);
        LOG_PRINTF("\tnonCoherentAtomSize: %lu", deviceProperties.limits.nonCoherentAtomSize);
        LOG_PRINTF("---- deviceProperties.limits ----");
    }
